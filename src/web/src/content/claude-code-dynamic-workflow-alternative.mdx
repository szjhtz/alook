...
<table>
  <thead>
    <tr>
      ...
      <th>Email Coordination (Alook)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Sweet spot</td>
      <td>500 files, right now</td>
      <td>3-month project</td>
    </tr>
    <tr>
      <td>How long</td>
      <td>Hours in one session</td>
      <td>Weeks to months</td>
    </tr>
    <tr>
      <td>Who uses it</td>
      <td>You, alone</td>
      <td>Team with handoffs</td>
    </tr>
    <tr>
      <td>Memory</td>
      <td>Gone when done</td>
      <td>Permanent timeline</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Can pause?</td>
      <td>No, runs to completion</td>
      <td>Yes, async everything</td>
    </tr>
    <tr>
      <td>Where it runs</td>
    ...
    <tr>
      <td>Frameworks</td>
      <td>Claude Code</td>
      <td>Codex, OpenCode, Claude Code, more coming</td>
    </tr>
  </tbody>
</table>
