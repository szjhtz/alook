 ...
 * about its own). Response shape is minimal — `id`, `name`, `description` —
 * for the daemon's `botsById` cache and system-prompt assembly. No avatar
 * (display-only, server does that).
 */
